...
## Bra namn ska vara korta och beskrivande
...
## Översätt fritextfält till andra språk
...
## Distributioner motsvarar samma data i olika format
...
## Vissa datamängder delas med fördel upp i flera filer
...
## Att koppla samman en datamängd med en arkivredovisning
...
## Utgivningsdatum, modifieringsdatum och uppdateringsfrekvens
